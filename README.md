...
Please remember to add this key to authorized_keys in your VPS. Below is an example command:
```bash
 cat ~/.ssh/dokploy_deploy.pub | ssh root@YOUR_SERVER_IP  "cat >> ~/.ssh/authorized_keys"
```
